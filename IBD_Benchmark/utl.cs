...
namespace IBD_Benchmark
{
    class utl
    {
        ...
        /// <summary>
        /// gives largest percentage of overlap
        /// </summary>
        /// <param name="r1_left"></param>
        /// <param name="r1_right"></param>
        /// <param name="r2_left"></param>
        /// <param name="r2_right"></param>
        /// <returns>-1 if there is no overlap</returns>
        public static double rangeOverLap_Percentage(double r1_left, double r1_right,
            double r2_left, double r2_right)
        {
            ...
            return Math.Max(len / (r1_right - r1_left), len / (r2_right - r2_left));
        }
        ...
        public class siteDict
        {
            ...
            public int Get_SiteIndex(int phy, bool startPhy)
            {
